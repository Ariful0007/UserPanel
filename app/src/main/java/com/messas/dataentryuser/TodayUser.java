...
public class TodayUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_today_user);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(TodayUser.this));
    ...
    private void searchAllUser(String newText) {
        final KProgressHUD progressDialog=  KProgressHUD.create(TodayUser.this)
        ...
        firebaseFirestore.collection("Daily")
            ...
            public void onFailure(@NonNull Exception e) {
                progressDialog.dismiss();
                Toast.makeText(TodayUser.this, "No data found", Toast.LENGTH_SHORT).show();
            }
        });
    }
